...
public class CameraActivityFragment extends android.app.Fragment
    ...
    VideoPathTransfer mVideoPathTransfer;
    /**
    ...
    public void onAttach(Activity activity) {
        ...
        mVideoPathTransfer = (VideoPathTransfer) activity;
    }
    ...
    private boolean shouldShowRequestPermissionRationale(String[] permissions) {
        for (String permission : permissions) {
            if (android.support.v13.app.FragmentCompat.shouldShowRequestPermissionRationale(this, permission)) {
                return true;
            }
        }
        return false;
