 ...
 */
public class Utils {
    public static final String API_KEY = "6e63c3c7d966e334108185e64356a681";
    public static final int _ID_INDEX = 0;
    public static final int TITLE_INDEX = 1;
    public static final int ENTRY_INDEX = 2;
    ...
    public static final String DATE_CREATED_JOURNAL = "date_created";
    ...
    public static final String MAIN_TEMP_MIN_WEATHER = "main_temp_min";
    public static final String MAIN_TEMP_MAX_WEATHER = "main_temp_max";
    public static final String MAIN_HUMIDITY_WEATHER = "main_humidity";
