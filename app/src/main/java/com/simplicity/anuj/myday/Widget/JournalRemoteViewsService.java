...
public class JournalRemoteViewsService extends RemoteViewsService {
    public JournalRemoteViewsService() {
        super();
    ...
    private class JournalRemoteViewsFactory implements RemoteViewsFactory {
        ...
        public void onDataSetChanged() {
            ...
            mContext.getContentResolver().query(JournalContentProvider.ContentProviderCreator.JOURNAL,
                    null,
                    null,
                    null,
                    null);
